...
struct CodexHistoryArchive: Sendable {
    ...
    static func decode(_ data: Data) throws -> Self {
        ...
        var archive = Self()
        archive.importedT3 = root["usageBarImportedT3"] as? Bool ?? false
        archive.t3Stamp = root["usageBarT3Stamp"] as? String
    ...
    func write(to url: URL) throws {
        ...
        var root: [String: Any] = [
            ...
            "usageBarImportedT3": self.importedT3,
        ]
        if let stamp = self.t3Stamp { root["usageBarT3Stamp"] = stamp }
