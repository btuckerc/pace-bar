...
The menu glyph is a four-part aperture drawn natively at 18 points, using template coloring for system appearance. It is static. There are no animated charts, browser views, or frame-rate timers.
